...
class VoyageController extends AbstractController
{
   ...
   /**
     ...
     */
    public function updateVoyageMobile(Request $request , SerializerInterface $normalizer) : Response{
        $em = $this->getDoctrine()->getManager();
        ...
        $em->persist($voyage);
        $em->flush();
        $formatted = $normalizer->normalize($voyage, 'json', ['groups' => 'post:read']);
        return new Response("Voyage a été modifier ".json_encode($formatted));
