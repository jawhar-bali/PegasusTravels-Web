...
class MaisonController extends AbstractController
{
   ...
   public function rechercheByName(Request $request)
     ...
     */
    public function updateMaisonMobile(Request $request,SerializerInterface $normalizer) : Response {
        $em = $this->getDoctrine()->getManager();
        ...
        $em->persist($maison);
        $em->flush();
        $formatted = $normalizer->normalize($maison, 'json', ['groups' => 'post:read']);
        return new Response("maison a été modifier ".json_encode($formatted));
