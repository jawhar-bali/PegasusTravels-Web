...
class EvenementBackController extends AbstractController
{
    ...
    /**
     * @Route("/r/search_back1", name="search_back2",methods={"GET"})
     */
    ...
    /**
     * @Route("DOWNtriEQUIPE", name="DOWNtriEQUIPE1",options={"expose"=true})
     */
    ...
    /**
     * @Route("UPtriEQUIPE", name="UPtriEQUIPE1",options={"expose"=true})
     */
